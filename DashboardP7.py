...
if __name__ == "__main__":
    ...
    if  st.sidebar.checkbox("Feature Analyze :"):
        ...
        with col1:
            ...
            fig = px.histogram(num_df, x=ID_var2, nbins=20, text_auto=True, barmode="overlay")
        ...
        with col1:
            ...
            # Mise en évidence de la valeur maximale de la colonne sélectionnée en rouge
            #fig2.add_traces(px.scatter( x=valueID, y=value0).update_traces(marker_size=20, marker_color="Red"))     

            # Affichage du scatterplot interactif avec Plotly
